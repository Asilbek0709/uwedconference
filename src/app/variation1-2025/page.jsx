...
export default function Variation1_2025(){

    const { t } = useTranslation()

    return(
        <section className="variation1-2025">
            <Header></Header>
            <div className="articles-container">
                    <div className="article-card">
                        <div className="article-info">
                            <h1>USING AUTHENTIC MATERIALS IN EFL CLASSROOMS: ENHANCING ADVANCED LEARNERS’ ENGAGEMENT AND LANGUAGE COMPETENCE</h1>
                            <p>G.N.Irmukhamedova</p>
                        </div>
                        <div className="article-navigation">
                            <p>1-8</p>
                            <div className="buttons">
                                <a href="/conference2025-files/1.pdf" target="_blank">{t("view")}</a>
                                <a href="/conference2025-files/1.pdf" download={true}>{t("upload")}</a>
                            </div>
                        </div>
                    </div>
                    <div className="article-card">
                        ...
                        <div className="article-navigation">
                            <p>9-15</p>
                            <div className="buttons">
                                <a href="/conference2025-files/2.pdf" target="_blank">{t("view")}</a>
                                <a href="/conference2025-files/2.pdf" download={true}>{t("upload")}</a>
                            </div>
                        </div>
                    </div>
                    <div className="article-card">
                        ...
                        <div className="article-navigation">
                            <p>16-21</p>
                            <div className="buttons">
                                <a href="/conference2025-files/3.pdf" target="_blank">{t("view")}</a>
                                <a href="/conference2025-files/3.pdf" download={true}>{t("upload")}</a>
                            </div>
                        </div>
                    </div>
                    <div className="article-card">
                        ...
                        <div className="article-navigation">
                            <p>22-27</p>
                            <div className="buttons">
                                <a href="/conference2025-files/4.pdf" target="_blank">{t("view")}</a>
                                <a href="/conference2025-files/4.pdf" download={true}>{t("upload")}</a>
                            </div>
                        </div>
                    </div>
                    <div className="article-card">
